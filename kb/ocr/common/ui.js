...
export const initDictationBoard = async (question, answerCount, boardWrapperElement, createAnswerCanvasWrapper, canvasWidth, canvasHeight, doesViewTextPath, failCnt, quiz_data) => {
    ...
    for (const dummy of [...Array(answerCount)]) {
        ...
        for (const character of characters) {
            ...
            //gridLayer.draw("pink");
            gridLayer.draw("black");
            //console.log(doesViewTextPath , character)
