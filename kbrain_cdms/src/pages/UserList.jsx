...
const UserList = (props) => {
  ...
  const getUserInfo = async () => {
    await axios.get("http://192.168.23.2:5001/user/list").then((res) => {
  ...
  const onSearch = async () => {
    await axios
      .post(`http://192.168.23.2:5001/user/search`, isSearch)
  ...
  const acctApproval = async (idx, e) => {
    await axios.patch(`http://192.168.23.2:5001/user/setlevel?idx=${idx}`);
    // await fetchUserList();
