...
const PercentBar = () => {
  const API_PRO = "http://192.168.23.2:5001/project";
  ...
  const fetchData = async () => {
    const projectData = await axios.get(`${API_PRO}`, {
      params: {
        code: projectCode,
      },
    });
    ...
    // console.log("fetch data", getChasiTotal.data);
  ...
  useEffect(() => {
    fetchData();
    console.log("chasiTotal", chasiTotal);
  }, []);
